...
public class Demo03 {
	...
	public static void test3() throws IOException, InterruptedException{
		...
		//String path="E:/xp/io_test/con"; //con系统关键字
		String path="E:/xp/io_test/200.jpg";
		//String path="E:/xp/io_test/1.jpg";
		...
		File temp= File.createTempFile("tes", ".temp",new File("e:/xp/io_test"));
		Thread.sleep(10000);		
	...
	public static void test1(){
		//File src =new File("E:/xp/io_test/2.jpg");
		//建立联系
